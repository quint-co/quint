...
A language server for the [Quint specification language](https://github.com/quint-co/quint).
...
2. The [Quint LSP client](https://github.com/quint-co/quint/blob/main/editor-plugins/emacs/README.md) for Emacs
3. A [Neovim LSP client](https://github.com/quint-co/quint/blob/main/editor-plugins/vim/README.md)
